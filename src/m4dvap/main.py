...
from voxel_wise_change_detection_01 import compute_bitemporal_vapc
from change_analysis_02 import ChangeAnalysisM3C2
...
def fn_parse_args():
    ...
    if sys.gettrace() is not None:
        ...
        if os.name == 'nt':
            args_filenames=[r"C:\Users\nc298\Documents\paper\2024_hierarchical_analysis_conf_paper\data\reference\full_pc\ScanPos001 - SINGLESCANS - 240826_000005.laz", r"C:\Users\nc298\Documents\paper\2024_hierarchical_analysis_conf_paper\data\reference\full_pc\ScanPos001 - SINGLESCANS - 240826_010006.laz"]
            args_config_file = r"C:\Users\nc298\repos\m4dvap\config\Trier_vs6_av_0.999.json"
